...
//#include "Util.h"
//
//void Util::Blit(SDL_Surface* Dest, int DestX, int DestY, SDL_Surface* Src)
//{
...
//}
//
//void Util::Blit(SDL_Surface* Dest, int DestX, int DestY, SDL_Surface* Src, int SrcX, int SrcY, int SrcW, int SrcH)
//{
